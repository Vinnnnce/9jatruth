    ...
    return [
      {
        ...
        headers: [
          ...
          { key: "Content-Security-Policy", value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://maps.googleapis.com https://maps.gstatic.com https://*.clerk.accounts.dev https://*.clerk.com https://clerk.com https://clerk.9jatruth.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://*.clerk.accounts.dev https://*.clerk.com https://clerk.9jatruth.com; img-src 'self' data: https: blob:; font-src 'self' https://fonts.gstatic.com; connect-src 'self' https://api.moonshot.ai https://maps.googleapis.com https://maps.gstatic.com https://*.clerk.accounts.dev https://*.clerk.com https://clerk.com https://clerk.9jatruth.com https://api.maptiler.com https://*.maptiler.com; frame-src 'self' https://www.google.com https://*.clerk.accounts.dev https://*.clerk.com https://clerk.9jatruth.com; worker-src 'self' blob:;" },
        ],
      },
    ];
  },
