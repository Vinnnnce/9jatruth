/**
 * Complete Nigeria geographic data: 36 states + FCT = 37 states, 774 LGAs total.
 * Source: Official Nigerian government administrative divisions.
 */
...
export const NIGERIA_LGAS: Record<string, string[]> = {
  ...
  "Akwa Ibom": [
    ...
    "Etinan", "Ibeno", "Ibesikpo Asutan", "Ibiono Ibom", "Ikono", "Ikot Abasi",
    "Ikot Ekpene", "Ini", "Itu", "Mbo", "Mkpat-Enin", "Nsit-Atai",
  ...
  "Benue": [
    ...
    "Katsina-Ala", "Konshisha", "Kwande", "Logo", "Obi", "Ogbadibo", "Oju",
    "Okpokwu", "Otukpo", "Ohimini", "Otukpa", "Tarka", "Ushongo", "Vandeikya", "Makurdi",
  ],
  "Borno": [
    "Abadam", "Askira/Uba", "Bama", "Bayo", "Biu", "Chibok", "Damboa", "Dikwa",
    "Gubio", "Guzamala", "Gwoza", "Hawul", "Jere", "Kaga", "Kala/Balge",
    "Konduga", "Kukawa", "Kwaya Kusar", "Mafa", "Magumeri", "Maiduguri", "Marte",
  ...
  "Imo": [
    "Abor Mbaise", "Ahiazu Mbaise", "Ehime Mbano", "Ezinihitte", "Ideato North",
  ...
  "Jigawa": [
    "Auza", "Babura", "Biriniwa", "Birnin Kudu", "Buji", "Dutse", "Gagarawa",
    "Garki", "Gumel", "Guri", "Gwaram", "Gwiwa", "Hadejia", "Jahun",
    "Kafin Hausa", "Kaugaama", "Kazaure", "Kirikasamma", "Kiyawa", "Maigatari",
  ...
  "Kano": [
    ...
    "Dawakin Kudu", "Dawakin Tofa", "Doguwa", "Fabedde", "Fagge", "Gabasawa",
  ...
  "Katsina": [
    "Batsari", "Baure", "Bindawa", "Charanchi", "Dandi", "Dan Musa", "Daura",
  ...
  "Kebbi": [
    ...
    "Maiyama", "Ngaski", "Sakaba", "Shanga", "Suru", "Yauri", "Zuru",
  ],
  "Kogi": [
  ...
  "Lagos": [
    ...
    "Lagos Island", "Lagos Mainland", "Mushin", "Ojo", "Shomolu", "Surulere", "Iwaya",
  ],
  "Nasarawa": [
  ...
  "Ogun": [
    "Abeokuta North", "Abeokuta South", "Ado-Odo/Ota", "Ewekoro", "Egbado North",
    "Egbado South", "Ifo", "Ijebu East", "Ijebu North", "Ijebu North East",
  ...
  "Oyo": [
    ...
    "Ogo Oluwa", "Olorunsogo", "Oluyole", "Ona Ara", "Orelope", "Ori Ire", "Oyo",
    "Oyo East", "Saki East", "Saki West", "Surulere",
  ],
  "Plateau": [
  ...
  "Sokoto": [
    "Bodinga", "Dange/Shuni", "Gada", "Gudu", "Goronyo", "Gwadabawa", "Illela",
    "Isa", "Kware", "Rabah", "Sabon Birni", "Shagari", "Silame", "Sokoto North",
...
export function getTotalLgas(): number {
  return Object.values(NIGERIA_LGAS).reduce((sum, lgas) => sum + lgas.length, 0);
}

export function getStateLgaCount(state: string): number {
  return (NIGERIA_LGAS[state] || []).length;
}
